...
let PoatekCoinERC20 = require('contracts/PoatekCoinERC20.json');
...
function mint(req, res) {
    ...
    const contract = new ethers.Contract(process.env.BLOCKCHAIN_CONTRACT_ADDRESS, PoatekCoinERC20.abi, ownerWallet)
