...
contract PoatekCoinERC20 is ERC20, Ownable {
    ...
    constructor(uint256 _initialSupply) ERC20("PoatekCoin", "WLC") {
    ...
    modifier mustWalletExist(address _address) {
        require(walletExists[_address] == true, "PoatekCoinERC20: Wallet does not exist");
        _;
    }

    modifier mustNotWalletExist(address _address) {
        require(walletExists[_address] == false, "PoatekCoinERC20: Wallet already exists");
        _;
    }
