...
export interface PoatekCoinERC20Interface extends utils.Interface {
  functions: {
...
export interface PoatekCoinERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoatekCoinERC20Interface;
